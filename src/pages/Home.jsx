...
const Home = () => {
  useEffect(() => {
    // Animation for when the Work component is scrolled into view
    gsap.fromTo(".work",
      {
        opacity: 0,
        y: 100,
      },
      {
        ...
        scrollTrigger: {
          ...
          end: "top 50%",    // The element stays in view until it reaches 50% of the viewport height
          scrub: true,
        },
      });

    // Animation for the footer (scrolls in after the gallery)
    gsap.fromTo(".footer",
      {
        opacity: 0,
        y: 100,
  ...
  return (
    <div className="max-w-screen-xl flex flex-col justify-center mx-auto">
      <div className="flex flex-col justify-center">
        <h1 className="heading text-center text-5xl py-2 px-1 mt-14 bg-gradient-to-r from-gray-500 to-zinc-600 bg-clip-text text-transparent">
          <q style={{ wordSpacing: "0.1em" }}> We are the working unit, for the difference of your brand's present and future.</q>
        </h1>
      </div>
      <div className="flex items-center mt-16 justify-center">
        <div className="about flex mt-8 mx-20 text-center text-2xl justify-center max-w-[1000px] items-center">
        ...
        {/* <div className="">
          <img src="https://images.unsplash.com/photo-1675789203977-70070dae0799" className="object-cover w-80 h-60" alt="" />
        </div> */}
      </div>
